...
exports.LEVEL = LEVEL;
},{}],"ghostMovements.js":[function(require,module,exports) {
"use strict";
...
var _ghostMovements = require("./ghostMovements");
...
var Ghost = /*#__PURE__*/function () {
  function Ghost() {
    ...
    var movementStrategy = arguments.length > 2 ? arguments[2] : undefined;
  ...
  (0, _createClass2.default)(Ghost, [{
    ...
    key: "getNextMove",
    value: function getNextMove(objectExist) {
      var _this$moveStrategy = this.moveStrategy(this.pos, this.dir, objectExist),
          nextMovePos = _this$moveStrategy.nextMovePos,
          direction = _this$moveStrategy.direction;
...
var _default = Ghost;
exports.default = _default;
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js","./ghostMovements":"ghostMovements.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
function startGame() {
  ...
  var ghosts = [new _Ghosts.default(5, 188, _ghostMovements.randomMovement, _setup.OBJECT_TYPE.BLINKY), new _Ghosts.default(4, 209, _ghostMovements.randomMovement, _setup.OBJECT_TYPE.PINKY), new _Ghosts.default(3, 230, _ghostMovements.randomMovement, _setup.OBJECT_TYPE.INKY), new _Ghosts.default(2, 251, _ghostMovements.randomMovement, _setup.OBJECT_TYPE.CLYDE)];
...
},{"./setup":"setup.js","./ghostMovements":"ghostMovements.js","./GameBoard":"GameBoard.js","./Pacman":"Pacman.js","./Ghosts":"Ghosts.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
